...
#colnames(cohort_summary) <- make.names(colnames(cohort_summary), unique = TRUE)
#names(cohort_summary)
#datatable(as.data.frame(cohort_summary), caption = "Número de exalumnos por cohorte")


datatable(cohort_summary, caption = "Número de exalumnos por cohorte")

#colnames(cohort_summary) <- gsub(" ", ".", colnames(cohort_summary))
#datatable(cohort_summary, caption = "Número de exalumnos por cohorte")

# Gráfico de barras del número de exalumnos por cohorte
ggplot(cohort_summary, aes(x = `Class Year`, y = Num_Exalumnos)) +
